...
namespace Foam
{
    defineTypeNameAndDebug(heightFunctionDLR, 0);
    addToRunTimeSelectionTable(curvatureModel,heightFunctionDLR, components);
}



void Foam::heightFunctionDLR::getStencilValues
(
...
bool Foam::heightFunctionDLR::fullColumn(const scalar avgHeight,const scalar tol)
{
    return (avgHeight >= (1-tol) || avgHeight < tol);
}

void Foam::heightFunctionDLR::nextCell
(
    const label celli,
...
void Foam::heightFunctionDLR::computeColumns
(
    const label dir,
    const Map<scalar>& mapAlpha,
    const label celli,
...
void Foam::heightFunctionDLR::exchangeStencils
(
...
Foam::scalar Foam::heightFunctionDLR::calcCurvature
(
...
Foam::heightFunctionDLR::heightFunctionDLR
(
...
/*void Foam::heightFunctionDLR::correctContactAngle
(
    surfaceVectorField::Boundary& nHatb,
    surfaceVectorField::Boundary& heightFunctionDLRf
)
{
    ...
    forAll(boundary, patchi)
    {
        if (isA<alphaContactAngleFvPatchScalarField>(abf[patchi]))
        {
            ...
            acap.gradient() = (nf & nHatp)*mag(heightFunctionDLRf[patchi]);
            acap.evaluate();
        }
    }
}*/
...
void Foam::heightFunctionDLR::calculateK()
{
    ...
    RDF_.markCellsNearSurf(interfaceCells,5);
    nextToInterface =RDF_.nextToInterface(); 
